...
Download the latest release of Quetoo for your platform. Each release includes the **Quetoo Installer** which can install or update the game.
...
<div class="download-grid">
  ...
  <div class="download-card">
    <div class="platform-icon">🐧</div>
    <h3>Linux</h3>
    <p>x86_64 build for GNU/Linux distributions.</p>
